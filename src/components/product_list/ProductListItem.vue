    ...
    <div class="row search-list-container ioo-no-gutters">
      <div class="col-4 pl-0">
        <div class="row ioo-no-gutters">
          <div v-if="this.ListItem.ShowThumbnail" class="col-4 pl-0 pr-0">
            <div class="list-avatar-block">
              <img src="@/assets/md-thumb-img.jpg">
            </div>
          </div>
          <div class="col-8 ioo-pl-20">
            <h6
        ...
        <div class="d-inline-flex">
          ...
          <div class="v-center-btn-block pr-4 ioo-pr-dk-10">
            <sana-inventory-check
              ...
              && this.ShopContext.IsUserAllowedActivity_30200 || true"
          ...
          <div
            v-if="this.UserHasAbilityTo('ViewPrices')"
            class="v-center-block pr-4 sprice-li-container ioo-pr-dk-10"
          >
            <!--if (showPrices) -->
            ...
            <div class="v-center-btn-block">
              ...
              <template v-if="true">
                <sana-link-button
                  ...
                  BtnClass="ioo-btn ioo-btn-default ioo-lt-20"
                  BtnTextClass="btn-text"
                  BtnTitle="Details"
