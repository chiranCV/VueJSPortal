<template>
  <div v-if="!isLoading">
      ...
      <div class="row">
        <div class="col-5">
          <div class="product-image">
            <img src="../../assets/lg-thumb-img.jpg" class="img-fluid" alt srcset>
          </div>
        </div>
        <div class="col-7">
            ...
            <div class="item-number">
              ...
              <div class="row mb-4 black-light font-verdana">
                <div class="col-12">
                  ...
                  <span
                    v-text="product.Weight + ' ' + this.GetSanaText('IOO_DetailsPage_Weight_'+this.ShopContext.WeightUnits,this.ShopContext.WeightUnits)"
                  ></span> |
                  <span>{{this.GetSanaText('DetailsPage_GrossWeight','Gross weight:')}}</span>
                  <span
                    v-text="product.ProductGrossWeight + ' ' + this.GetSanaText('IOO_DetailsPage_Weight_'+this.ShopContext.WeightUnits,this.ShopContext.WeightUnits)"
                  ></span>
                </div>
              </div>
              <br v-if="this.IsPrintPreviewMode">
              <div class="row ioo-mb-20 mt-2 font-verdana date-picker-container">
                ...
                <div class="col-8 date-picker-primary" v-if="!this.IsPrintPreviewMode">
                  <date-picker v-bind:DisableDates="diableDates" v-on:onDateChange="onDateChange"></date-picker>
                </div>
                <div class="print-date-block" v-else v-text="PreSelectedRequestDeliveryDateValue"/>
              </div>
              <div class="row mb-3 font-verdana">
                ...
                <div class="qty-box">
                  <sana-quantiy-box
                    v-if="!this.IsPrintPreviewMode"
                    v-bind:QuantityModel="this.quantityModel"
                    v-on:onQuantityChange="onQuantityChange"
                    v-bind:UOM="this.product.UnitOfMeasureId"
                  />
                  <span v-else v-text="PreSelectedQuantityValue"></span>
                </div>
                ...
                <div class="col-4 dropdown-list-text-only mt-3 pl-0">
                  ...
                  />
                  <span v-else v-text="PreSelectedProductTypeValue"></span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-8">
                  ...
                  <template
                    v-if="this.UserHasAbilityTo('OrderProducts') & !this.IsPrintPreviewMode"
                  >
                    <sana-button
                      BtnId="addToCart"
                ...
                <sana-button
                  v-if="this.IsPrintPreviewMode && !isChromeBrowser()"
                  ...
                  BtnText="Print"
                  BtnPostTextClass="btn-arrow-right"
                  v-on:onButtonClick="printWondow"
                ></sana-button>

                <div class="col-4" v-if="!this.IsPrintPreviewMode">
                  <sana-print-preview
    ...
    <div v-if="!this.IsPrintPreviewMode">
      <sana-last-viewed
...
export default {
  ...
  computed: {
    ...
    IsPrintPreviewMode() {
      return this.IsPrintPreview || this.$route.query.print === "1";
    },
    PreSelectedProductTypeValue() {
      if (this.$route.query.print === "1" && this.$route.query.type) {
        return this.$route.query.type;
      }
      return this.PreSelectedProductType;
    },
    PreSelectedRequestDeliveryDateValue() {
      if (this.$route.query.print === "1" && this.$route.query.date) {
        return this.$route.query.date;
      }
      return this.PreSelectedRequestDeliveryDate;
    },
    PreSelectedQuantityValue() {
      if (this.$route.query.print === "1" && this.$route.query.quantity) {
